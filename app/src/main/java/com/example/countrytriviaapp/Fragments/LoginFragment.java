...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView emailTxt = view.findViewById(R.id.loginFragment_email_textInput);
        TextView passwordTxt = view.findViewById(R.id.loginFragment_password_textInput);
        ...
        resetPasswordBtn = view.findViewById(R.id.loginFragment_forgotPassword_button);
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mainActivity.mainFragmentManager(new LoginFragment());
